...
Fuzzing tools that offer generation based funktionalities use such grammars in their inner working flow to create test-cases. \\
...
Protocol fuzzers will mostly focus on communication patterns. This could be different data packets of network traffic like http requests, tcp streams et cetera. Since such protocolls are often complex and very case sensitive, it requires good knowledge to test them. In here generation based fuzzers are the method of choice!

File format fuzzing will fuzz different file formats such as jpg etc. \dots
\newpage
\section{Tooling}
